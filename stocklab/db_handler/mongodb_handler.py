...
class MongoDBHandler:
    ...
    def __init__(self):
        ...
        db_connecting = "mongodb://stocklab-admin:yfzqvg0BmhH0AVdTKiGAxKLlg5mmmXcnpbIx2Rrmi2UPK0HnOjZPcLia6E2odSOHgoaVJhAH1sIjn7ckmAQybA==@stocklab-admin.mongo.cosmos.azure.com:10255/?ssl=true&retrywrites=false&replicaSet=globaldb&maxIdleTimeMS=120000&appName=@stocklab-admin@"
        self._client = MongoClient(db_connecting)
    ...
    def insert_items(self, datas, db_name=None, collection_name=None):
        ...
        :param db_name:str: MongoDB에서 데이터베이스에 해당하는 이름을 받습니다.
        :param collection_name:str: 데이터베이스를 속하는 컬렉션 이름을 받습니다.
        :return inserted_ids: 입력 완료된 문서의 ObjectId list를 반환합니다.
        :raises ExceptionL: 매개변수 db_name과 collection_name이 없으면 예외(Exception)를 발생시킵니다.
        """
    ...
    def find_items(self, condition=None, db_name=None, collection_name=None):
        """
        MongoDB에 여러 개의 문서(document)를 검색하기 위한 에서드입니다.
        :param condition:dict: 감색 조건을 딕셔너리 형태로 받습니다.
        :param db_name:str: MongoDB에서 데이터베이스에 해당하는 이름을 받습니다.
        :param collection_name:str: 데이터베이스에 속하는 컬렉션 이름을 받습니다.
    ...
    def find_item(self, condition=None, db_name=None, collection_name=None):
        """
        MongoDB에 하나의 문서(document)를 검색하기 위한 에서드입니다.
        :param condition:dict: 감색 조건을 딕셔너리 형태로 받습니다.
        :param db_name:str: MongoDB에서 데이터베이스에 해당하는 이름을 받습니다.
        :param collection_name:str: 데이터베이스에 속하는 컬렉션 이름을 받습니다.
    ...
    def delete_items(self, condition=None, db_name=None, collection_name=None):
        """
        MongoDB에 여러 개의 문서(document)를 삭제하기 위한 매서드입니다.
    ...
    def update_items(self, condition=None, update_value=None, db_name=None, collection_name=None):
        """
        MongoDB에 여려 개의 문서(document)를 갱신하기 위한 메서드입니다.
    ...
    def aggregate(self, pipeline=None, db_name=None, collection_name=None):
        """
        MongoDB의 agreegate 작업을 위한 메서드입니다.
