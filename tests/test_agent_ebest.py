...
class TestEBest(unittest.TestCase):
    ...
    #     print(inspect.stack()[0][3])
    #     result = self.ebest.get_credit_trend_by_code("005930", "20210709")
    #     assert result is not None
    #     print(result)
    ...
    #     print(inspect.stack()[0][3])
    #     result = self.ebest.order_stock("005930", "2", "60000", "2", "00")
    #     assert result
    #     print(result)
    ...
    def test_get_price_n_min_by_code(self):
        print(inspect.stack()[0][3])
        result = self.ebest.get_price_n_min_by_code("20210715", "180640")
        assert result
        print(result)

    def test_get_price_n_min_by_code_tick(self):
        print(inspect.stack()[0][3])
        result = self.ebest.get_price_n_min_by_code("20210715", "180640", 0)
        assert result
        print(result)
